...
<template>
    ...
    <div class="w-full navbar bg-white shadow-sm dark:bg-[#242424] dark:text-white">
        ...
        <div class="flex-1 px-2 mx-2 ">
          <a href="#" @click="router.back()" class="back  hover:bg-gray-200 py-1 pr-2 pl-1 rounded active:bg-gray-100 dark:bg-white"><BackIcon class="w-[26px] "/></a>
      ...
      <div class="drawer-side z-50">
        ...
        <ul class="menu p-4 w-80 h-full bg-base-200 relative dark:bg-[#242424] dark:text-white">
